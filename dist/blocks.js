...
function TwoFactorScanStep({
  ...
  const keyLabelId = useId3();
  const qrContent = qrCode ?? (qrCodeSvg ? /* @__PURE__ */ jsx20(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx20(
          "div",
          {
            ...
            children: qrContent ? /* @__PURE__ */ jsx20("div", { "data-slot": "two-factor-qr-frame", className: qrFrame, children: qrContent }) : /* @__PURE__ */ jsx20("p", { className: "text-sm font-medium text-muted-foreground", children: text.qrFallbackLabel })
          }
        ),
        manualSetupKey && /* @__PURE__ */ jsxs20(Field, { slotName: "two-factor-setup-key", children: [
          /* @__PURE__ */ jsx20(FieldLabel, { id: keyLabelId, children: text.manualKeyLabel }),
          /* @__PURE__ */ jsx20(FieldDescription, { children: text.manualKeyDescription }),
          /* @__PURE__ */ jsx20(FieldControl, { role: "group", "aria-labelledby": keyLabelId, children: /* @__PURE__ */ jsxs20(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx20(
                  Button,
                  {
                    ...
                    onClick: () => setRevealed(!revealed),
                    children: revealed ? /* @__PURE__ */ jsx20(EyeOff2, {}) : /* @__PURE__ */ jsx20(Eye2, {})
                  }
                ),
                /* @__PURE__ */ jsx20(
                  CopyButton,
...
function TwoFactorSetupDialog({
  ...
  return /* @__PURE__ */ jsx21(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxs21(
    DialogContent,
    {
      ...
      slotName,
      children: [
        /* @__PURE__ */ jsxs21(DialogHeader, { className: "shrink-0", children: [
        ...
        /* @__PURE__ */ jsxs21(
          "div",
          {
            ...
            children: [
              step === "scan" && (ready ? /* @__PURE__ */ jsx21(
                TwoFactorScanStep,
                {
                  qrCode,
                  qrCodeSvg,
        ...
        action && /* @__PURE__ */ jsx21(
          "div",
          {
            "data-slot": "two-factor-setup-footer",
            className: "px-6 pb-6 md:px-8 md:pb-8 flex shrink-0 flex-col",
            children: /* @__PURE__ */ jsx21(Button, { type: "button", onClick: action.onClick, children: action.label })
          }
        )
      ]
    }
