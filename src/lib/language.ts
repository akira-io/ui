...
export const nestedSurfaceReset =
    'nested-surface:rounded-none nested-surface:border-0 nested-surface:ring-0 nested-surface:bg-transparent nested-surface:shadow-none nested-surface:backdrop-blur-none';
