...
>(({ index, className, ...props }, ref) => {
    ...
    return (
        <div
            ref={ref}
            className={cn(
                'h-9 w-9 text-sm shadow-sm relative flex items-center justify-center border-y border-r border-input transition-all first:rounded-l-md first:border-l last:rounded-r-md',
